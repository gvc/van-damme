...
pub const CYAN: Color = Color::Rgb(0x40, 0xa0, 0xb0); // cyan — muted cyan, active windows/info
pub const CYAN_VIVID: Color = Color::Rgb(0x00, 0xc8, 0xc8); // cyan_vivid — minimap roads, bright indicators
pub const GREEN: Color = Color::Rgb(0x40, 0xa0, 0x40); // green — terminal green, success/git add
